...
echo "[1/3] 清理上次演示产物（保留数据文件）..."
rm -f demo_analysis/analysis.py demo_analysis/analysis_report.txt
echo "[2/3] 启动真实演示：Excel 数据分析..."
echo "[3/3] agent 将自主读取 240 行成绩数据、计算指标、分组对比、输出分析报告"
